...
public class WekaPredictorTest {
    ...
    public void test() {
        ...
        BasicFeatureVectorImpl v1 = new BasicFeatureVectorImpl();
        ...
        BasicFeatureVectorImpl v2 = new BasicFeatureVectorImpl();
        ...
        BasicFeatureVectorImpl testVector = new BasicFeatureVectorImpl();
