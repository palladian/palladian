...
public interface FeatureVector extends Vector<String, Value> {
     ...
     * @throws ClassCastException in case the value is not nominal
     */
     ...
     * @param key The key of the value to get.
     * @return The numeric value, never <code>null</code>.
     * @throws ClassCastException in case the value is not boolean
     */
     ...
     * filter.
     *
     * @param nameFilter The filter, not <code>null</code>.
