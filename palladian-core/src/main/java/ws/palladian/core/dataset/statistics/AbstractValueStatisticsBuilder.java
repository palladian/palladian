 ...
 * @param <S>
 */
public abstract class AbstractValueStatisticsBuilder<V extends Value, S extends ValueStatistics>
		implements ValueStatisticsBuilder<S> {
	...
	public final void add(Value value) {
		if (value instanceof NullValue) {
			...
			throw new IllegalArgumentException(
					"Expected value to be of type " + valueType + ", but was " + value.getClass());
		}
	}
