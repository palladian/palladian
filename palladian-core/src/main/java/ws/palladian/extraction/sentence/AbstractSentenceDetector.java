...
/**
 * <p>
 * Abstract base class for all sentence detectors. Subclasses of this class
 * provide an implementation to split texts into sentences.
 * </p>
 * <p>
 ...
 * </pre>
 * 
 * It will return an array containing annotations for the two sentences:
 * "This is my sentence." and "This is another!". Annotations are pointers into
 * a {@link PipelineDocument} created from the input String, marking the start
 * index and end index of the extracted sentence. To access the value just call
 * {@link Annotation#getValue()}.
 * </p>
 * <p>
 * You can reuse an instance of this class if you want to. Simply call
 * {@link #detect(String)} or {@link #detect(String, String)} on a new
 * {@code String}, consisting out of multiple sentences.
 * </p>
 * 
 * @author Martin Wunderwald
 * @author Klemens Muthmann
 */
public abstract class AbstractSentenceDetector extends
		AbstractPipelineProcessor<String> {

	/**
	 * <p>
	 * Used for serializing and deserializing this object. Do change this value
	 * if the objects attriutes change and thus old serialized version are no
	 * longer compatible.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The world wide unique identifier of the {@link Feature}s created by this
	 * annotator.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The world wide unique feature descriptor of the {@link Feature} created
	 * by this annotator.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Creates anew completely initialized sentence detector working on the
	 * "originalContent" view if used as {@code PipelineProcessor}.
	 * </p>
	 */
	public AbstractSentenceDetector() {
		super();
	...
	/**
	 * <p>
	 * Chunks a text into sentences. Method returns <code>this</code> instance
	 * of AbstractSentenceDetector, to allow convenient concatenations of method
	 * invocations, like:
	...
	/**
	 * <p>
	 * Provides the trained model used to chunk a text into sentences. This is
	 * usually created from a text where existing sentences are annotated. For
	 * further information look up literature about machine learning and natural
	 * language processing.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Provides the sentences extracted by the previous call to
	 * {@link #detect(String)} or {@link #detect(String, String)}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Resets ond overwrites the last extraction result with the current one in
	 * the form of sentece {@code Annotation}s.
	 * </p>
	 * 
	 * @param sentences
	...
	@Override
	protected final void processDocument(PipelineDocument<String> document) {
		detect(document.getOriginalContent());
		Annotation[] sentences = getSentences();
		List<Annotation> sentencesList = Arrays.asList(sentences);
		AnnotationFeature sentencesFeature = new AnnotationFeature(
				PROVIDED_FEATURE, sentencesList);
