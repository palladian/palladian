...
public class PalladianContentExtractor extends WebPageContentExtractor {
    ...
    private void removeCommentNodes() {
        ...
        List<Node> divs = XPathHelper
                .getXhtmlNodes(
                        document,
                        "//*[(self::xhtml:div) or (self::xhtml:p) or (self::xhtml:section) or (self::xhtml:ol) or (self::xhtml:ul) or (self::xhtml:li)][@class='comment' or contains(@class,'comments ') or contains(@class,' comments') or contains(@id,'comments') or @id='disqus_thread']");
        for (Node node : divs) {
