...
public final class KeyWords {
    ...
    public static final String[] ARFF_KEYWORDS = {"date", "null", "posted", "update", "release", "added", "updated", "create", "publish", "released", "published", "revised",
            "created", "pdate", "revise", "last modified", "date-header", "pubdate", "datetime", "geschrieben"};
    ...
    public static final String[] HEAD_KEYWORDS = {"published", "publish", "article:published_time", "pubdate", "publish-date", "datePublished", "posted", "released", "release",
            "displaydate", "create", "update", "updated", "last-modified", "modified", "pdate", "date", "change"};

    /** Keywords found in HTML structure of documents. */
    public static final String[] DATE_BODY_STRUC = {"published", "publish", "posted", "create", "created", "released", "pubdate", "pdate", "date_first_released",
            "date_last_published", "displaydate", "display_date", "last-modified", "last modified", "date-last-modified", "update", "dc:date", "xsd:date", "xsd:dateTime", "date",
            "time", "datetime", "datestamp", "date-header", "revised", "revise"};
    ...
    public static final String[] BODY_CONTENT_KEYWORDS_ALL = {"published", "publish", "posted", "created", "create", "released", "release", "pubdate", "veröffentlicht",
            "geschrieben", "added", "updated", "update", "pdate", "revised", "revise", "aktualisiert", "date_first_released", "date_last_published", "displaydate", "display_date",
            "date-last-modified", "last-modified", "last modified", "datetime", "datestamp", "date-header", "date"};

    /** Keywords belonging to first priority class. */
    private static final String[] FIRST_PRIORITY_KEYWORDS = {"published", "publish", "posted", "released", "release", "pubdate", "pdate", "date_first_released",
            "date_last_published", "displaydate", "display_date", "Veröffentlicht", "create", "created", "added", "geschrieben"};
