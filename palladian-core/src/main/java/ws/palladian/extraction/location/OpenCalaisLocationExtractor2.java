 ...
 * @author Philipp Katz
 */
public class OpenCalaisLocationExtractor2 extends LocationExtractor {

    // XXX plenty of copied code from OpenCalaisNer; inheritance structure does not allow common base though currently.

    /** The logger for this class. */
    private static final Logger LOGGER = LoggerFactory.getLogger(OpenCalaisLocationExtractor2.class);
    ...
    public OpenCalaisLocationExtractor2(String apiKey) {
    ...
    public static void main(String[] args) {
        OpenCalaisLocationExtractor2 extractor = new OpenCalaisLocationExtractor2("mx2g74ej2qd4xpqdkrmnyny5");
