...
public class DatasetProcessor {
     ...
     */
    public List<String> splitFile(String datasetPath, String documentSeparator, int minDocuments, int maxDocuments, int stepSize) {
    ...
    public void createSubsets(String datasetPath, int minSeeds, int maxSeeds, int stepSize) {
        ...
        for (int numberOfSeeds = minSeeds; numberOfSeeds <= maxSeeds; numberOfSeeds += stepSize) {
            ...
            Annotations<Annotation> annotations = FileFormatParser.getSeedAnnotations(columnFilePath, numberOfSeeds);
            ...
            for (String document : documents) {
                ...
                for (Annotation annotation : annotations) {
                    ...
                    document = document.replace(annotation.getValue(), "<" + tagName + ">" + annotation.getValue() + "</" + tagName + ">");
