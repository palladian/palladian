...
public class TextVectorizer extends AbstractDatasetFeatureVectorTransformer implements ITextVectorizer {
    ...
    public TextVectorizer(String inputFeatureName, FeatureSetting featureSetting, Dataset dataset, TFStrategy tfStrategy, IDFStrategy idfStrategy, int vectorSize) {
        this(inputFeatureName, featureSetting, dataset, tfStrategy, idfStrategy, vectorSize, 0);
    }

    public TextVectorizer(String inputFeatureName, FeatureSetting featureSetting, Dataset dataset, TFStrategy tfStrategy, IDFStrategy idfStrategy, int vectorSize, int alpha) {
    ...
    private TextVectorizer(String inputFeatureName, FeatureSetting featureSetting, TermCorpus termCorpus, TFStrategy tfStrategy, IDFStrategy idfStrategy, int alpha) {
        this.inputFeatureName = inputFeatureName;
        this.featureSetting = featureSetting;
     ...
     * strategies.
     *
     * @param tfStrategy  The new {@link TFStrategy} to use.
     * @param idfStrategy The new {@link IDFStrategy} to use.
    ...
    public String toString() {
        return String.format("%s [%s, %s, alpha=%s, %s]", this.getClass().getSimpleName(), tfStrategy, idfStrategy, alpha, featureSetting);
    }
