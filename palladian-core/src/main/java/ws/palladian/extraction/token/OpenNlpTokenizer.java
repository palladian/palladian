...
/**
 * <p>
 * A {@link TokenizerInterface} implemenation based on <a href="http://opennlp.apache.org/">Apache OpenNLP</a>. OpenNLP
 * provides several different tokenizers, ranging from simple, rule-based ones to learnable tokenizers relying on a
 * trained model. For more information, see the documentation <a href=
 * "http://opennlp.apache.org/documentation/1.5.2-incubating/manual/opennlp.html#tools.tokenizer" >section on
 * tokenization</a> in the OpenNLP Developer Documentation.
 * </p>
 * 
 * @author Philipp Katz
 */
public final class OpenNlpTokenizer extends AbstractDefaultPipelineProcessor implements TokenizerInterface {
