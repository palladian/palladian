...
public interface TokenizerInterface extends PipelineProcessor<String> {
	 ...
	 * </p>
	 */
	static final FeatureDescriptor<AnnotationFeature> PROVIDED_FEATURE_DESCRIPTOR = FeatureDescriptorBuilder
