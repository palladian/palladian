...
public class CsvDatasetReaderConfig {
    public static final class Builder implements Factory<CsvDatasetReader> {
        ...
        private static final ValueParser[] DEFAULT_PARSERS = new ValueParser[]{ImmutableBooleanValue.PARSER, ImmutableDoubleValue.PARSER, ImmutableStringValue.PARSER};
        ...
        /**
         * @param readHeader Specify whether to treat the first line as header with
        ...
        /**
         * @param fieldSeparator The separator between entries, usually colon or semicolon.
         * @return The builder.
        ...
        /**
         * @param readClassFromLastColumn <code>true</code> to tread the last column in the CSV as
         ...
         *
         * @param name   A filter for the column name (thus allowing to specify the
        ...
        /**
         * @param nullValue The character(s) to be treated as {@link NullValue}.
        ...
        /**
         * @param nullValues A filter which determines which values to treat as
        ...
        /**
         * @param gzip <code>true</code> in case the input file is gzip
         *             compressed.
         * @return The builder.
         ...
         *
         * @param compression The compression to use, or <code>null</code> in case an
         ...
         *
         * @param name Filter for the column names to skip.
         * @return The builder.
         */
         ...
         *
         * @param parsers The default parsers.
         * @return The builder.
         */
         ...
         *
         * @param trim <code>true</code> to trim whitespace.
         * @return The builder.
         */
         ...
         *
         * @param unescapeDoubleQuotes <code>true</code> to unescape.
         * @return The builder.
         */
