...
public final class SingleFeatureClassification extends AbstractFeatureRanker {
     ...
     */
    public <R, M extends Model> SingleFeatureClassification(Learner<M> learner, Classifier<M> classifier, ClassificationEvaluator<R> evaluator, Function<R, Double> mapper) {
     ...
     */
    @Deprecated
    public <M extends Model> SingleFeatureClassification(Learner<M> learner, Classifier<M> classifier, Function<ConfusionMatrix, Double> scorer) {
