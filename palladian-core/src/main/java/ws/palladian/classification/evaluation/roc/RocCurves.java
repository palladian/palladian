...
public class RocCurves implements Iterable<RocCurves.EvaluationPoint>, Graph {
    ...
    public static final class RocCurvesEvaluator extends AbstractClassificationEvaluator<RocCurves> {
        ...
        /**
         * @param trueCategory The category name which is to be treated as the "correct"
         *                     class, e.g. "true".
         */
    ...
    public static class RocCurvesBuilder implements Factory<RocCurves> {
         ...
         * be combined.
         *
         * @param rocCurves The curves to add.
         */
    ...
    public static final class EvaluationPoint {
        ...
        public String toString() {
            return AbstractGraphPainter.format(threshold) + ": sensitivity=" + AbstractGraphPainter.format(sensitivity) + ", specificity=" + AbstractGraphPainter.format(
                    specificity);
        }
    }
    ...
    public double getAreaUnderCurve() {
        ...
        for (EvaluationPoint current : this) {
            if (previous != null) {
                ...
                areaUnderCurve += (-current.specificity + previous.specificity) * (current.sensitivity + previous.sensitivity);
            }
            previous = current;
        }
     ...
     *
     * @param stream    The destination stream, not <code>null</code>.
     * @param separator The separator between the two entries, e.g. <tt>;</tt>.
     */
     ...
     *
     * @param rocCurves The ROC curves.
