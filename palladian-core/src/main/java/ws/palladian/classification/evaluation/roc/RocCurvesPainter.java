...
public class RocCurvesPainter extends AbstractGraphPainter<RocCurves> {
    ...
    protected JFreeChart createChart() {
        ...
        for (NamedDiagram<RocCurves> namedCurve : diagrams) {
            XYSeries series = new XYSeries(namedCurve.name + " [AUC = " + format(namedCurve.diagram.getAreaUnderCurve()) + "]");
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("ROC Curves", "False Positive Rate (1 – Specificity)", "True Positive Rate (Sensitivity)", dataset,
