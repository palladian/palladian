...
public class WordTransformerTest {
    ...
    public void testSplitGermanCompounds() {
        ...
        assertEquals(2, words.size());
        assertEquals("fahrrad", words.get(0));
        assertEquals("schloss", words.get(1));
    ...
    public void testWordToSingularGerman() {
        assertEquals("unterwäsche", WordTransformer.wordToSingular("Unterwäsche", Language.GERMAN));
    ...
    public void testWordToPluralGerman() {
        assertEquals("serveranzahlen", WordTransformer.wordToPlural("serveranzahl", Language.GERMAN));
    ...
    public void testStemEnglishWords() {
        assertEquals("news", WordTransformer.stemEnglishWords("news", true));
        assertEquals("bab", WordTransformer.stemEnglishWords("babies", true));
        assertEquals("flight", WordTransformer.stemEnglishWords("flights", true));
