...
public class DateArrayHelperTest {
    ...
    public void testArrangeByDate() {
        ...
        ExtractedDate date = DateParser.parse("2010-08-01", "YYYY-MM-DD");
        array.add(date);
        date = DateParser.parse("2010-08-02", "YYYY-MM-DD");
        array.add(date);
        date = DateParser.parse("2010-08-03", "YYYY-MM-DD");
        array.add(date);
        date = DateParser.parse("2010-08-04", "YYYY-MM-DD");
        array.add(date);
        date = DateParser.parse("2010-08-05", "YYYY-MM-DD");
        array.add(date);
        date = DateParser.parse("2010-08-03", "YYYY-MM-DD");
        array.add(date);
        date = DateParser.parse("2010-08-04", "YYYY-MM-DD");
