...
public class EvaluationResultTest {
    ...
    public void testEvaluationResult() throws FileNotFoundException {
        ...
        Annotations goldStandard = FileFormatParser.getAnnotationsFromXmlFile(goldFile);
        Annotations nerResult = FileFormatParser.getAnnotationsFromXmlFile(resultFile);
