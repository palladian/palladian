...
public class LocationSetTest {
    ...
    private final Location l1 = new ImmutableLocation(2028461, "Ulaanbaatar Hot", null, UNIT, GeoCoordinate.from(47.91667, 106.91667), 844818l,
            Arrays.asList(2029969, 6255147, 6295630));
    private final Location l2 = new ImmutableLocation(2028462, "Ulaanbaatar", null, CITY, GeoCoordinate.from(47.90771, 106.88324), 844818l,
            Arrays.asList(2028461, 2029969, 6255147, 6295630));
    private final Location l3 = new ImmutableLocation(6295630, "Earth", null, REGION, GeoCoordinate.from(0., 0.), 6814400000l, Collections.<Integer>emptyList());
