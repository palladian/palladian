...
public class NaiveBayesClassifierTest {
    ...
    private double testWithSplit(List<NominalInstance> instances) {
        ...
        NaiveBayesClassifier bayesClassifier = new NaiveBayesClassifier();
        NaiveBayesModel bayesModel = bayesClassifier.learn(train);

        int correctlyClassified = 0;
        for (NominalInstance testInstance : test) {
            CategoryEntries prediction = bayesClassifier.predict(testInstance.featureVector, bayesModel);
