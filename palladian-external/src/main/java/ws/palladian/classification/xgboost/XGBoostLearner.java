...
public class XGBoostLearner extends AbstractLearner<XGBoostModel> {
	...
	public XGBoostModel train(Dataset training, Dataset validation) {
		...
		List<String> featureIndices = new ArrayList<>(
				training.getFeatureInformation().getFeatureNamesOfType(NumericValue.class));
	...
	private static DMatrix makeMatrix(Dataset dataset, Map<String, Integer> labelIndices,
			Map<String, Integer> featureIndices) throws XGBoostError {
	...
	static long makeRow(Map<String, Integer> featureIndices, TFloatArrayList data, TIntArrayList index,
