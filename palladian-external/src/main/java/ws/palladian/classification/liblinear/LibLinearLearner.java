...
import ws.palladian.classification.utils.*;
...
public final class LibLinearLearner extends AbstractLearner<LibLinearModel> {
     ...
     * </p>
     *
     * @param normalizer The normalizer to use, not <code>null</code>. Use a
    ...
    public String toString() {
        return String.format("%s [SolverType=%s, C=%s, eps=%s, bias=%s]", getClass().getSimpleName(), parameter.getSolverType(), parameter.getC(), parameter.getEps(), bias);
    }
