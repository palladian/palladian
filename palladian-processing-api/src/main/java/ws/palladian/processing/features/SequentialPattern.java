...
public final class SequentialPattern extends AbstractFeature<List<String>> {
    ...
    // /**
    // * <p>
    // * Calculates whether one {@code LabeledSequentialPattern} is contained within another one. The containment
    // relation
    ...
    // * distance is calculated similar as for {@code String}s but compares elements from the patterns against each
    // other.
    // * </p>
    // *
    // * @param otherPattern The {@code LabeledSequentialPattern} to compare to.
