...
public class BasicFeatureVectorImpl implements FeatureVector {
    ...
    /**
     * <p>
     * Creates a new {@link BasicFeatureVectorImpl} from the provided FeatureVector, i.e. a copy with all {@link Feature}s.
     * </p>
     * 
    ...
    /**
     * <p>
     * Adds all provided {@link Feature}s to this {@link BasicFeatureVectorImpl} and overwrites existing {@link Feature}s with
     * the same name.
     * </p>
     * 
    ...
    /**
     * <p>
     * Provides all direct {@link Feature}s of this {@link BasicFeatureVectorImpl}. Remember that each {@link Feature} may have
