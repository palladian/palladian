...
public class Experimenter {
     ...
     * @param resultsDirectory The directory where result CSV will be stored.
     */
     ...
     * @param testing          The testing data.
     * @param resultsDirectory The directory where result CSV will be stored.
     * @param trueClass        Value of the true class.
     */
    ...
    /**
     * @param classLabels The classes on which to evaluate.
     ...
     *
     * @param transformer The transformer for the features.
     * @return This instance.
     */
     ...
     * @param featureSets Filters for the features to use.
     * @return This instance.
     */
    ...
    /**
     * @param learnerClassifier The learner and classifier.
     * @param featureSets       Filters for the features to use.
     * @return This instance.
     */
            ...
            for (Predicate<? super String> featureSet : experiment.featureSets) {
                ...
                for (DatasetTransformer transformer : transformers) {
                    ...
                    if (!summaryCsv.exists()) {
                        ...
                        csvResult.append(
                                "details;learner;classifier;featureSet;numFeatures;transformer;timeTraining;timeTesting;precision;recall;f1;accuracy;superiority;matthewsCorrelationCoefficient;rocAuc\n");
                    }
                    if (classLabel != null) {
