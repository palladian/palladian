...
\chapter{Management of the code base}
...
Text classification is the process of assigning one or more categories to a given text document. There are several types of text classification which are shown in Figure \ref{}. The TOOLKIT can classify text in a single category, multiple categories, or in a hierarchical manner.
%TODO image
...
The text classifiers perform the actual classification task by calculating the most relevant category for the input document. CONTINUEHERE
...
\paragraph{Retrieval of Information from Sources available through the web}
