...
\begin{enumerate}
\item New algorithms in the fields of classification, extraction, and information retrieval that can easily be tested and applied to other projects.
...
TOOLKIT is not a complete natural language processing suite nor does it contain a {\textit complete} set of algorithms in any of the fields of classification, extraction, or information retrieval. TOOLKIT is not commercial either, we like to answer questions as soon and comprehensive as possible but cannot guarantee this support.

\section{Who is the intended audience?}
All algorithms are developed during scientific endeavors and therefore are also most likely to help other researchers who don't need perfect, bug-free software in commercial systems. In general everybody is welcome to use TOOLKIT though.
...
\end{lstlisting}
%\caption{Use a trained text classifier.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Evaluating a trained text classifier.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Learning the best parameter combination for a text classifier.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Using the controlled tagger.}
\end{codelisting}
...
ner.tag(inputText);
\end{lstlisting}
%\caption{Tagging a text using a named entity recognizer.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Reading a model's meta data.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Train a named entity recognizer.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Evaluating the performance of a named entity tagger.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Detecting the age of a web page.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Extract an FAQ from a web page.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Extract a list of facts from a web page.}
\end{codelisting}
...
\end{lstlisting}
%\caption{Retrieving result URLs from a search engine.}
\end{codelisting}
...
// This is another one!
\end{lstlisting}
%\caption{Using the sentence splitter.}
\end{codelisting}
...
// city
\end{lstlisting}
%\caption{Transforming words from singular to plural and vice versa.}
\end{codelisting}
