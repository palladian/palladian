...
\begin{codelisting}
\label{listing:trainControlledTagger}
\begin{lstlisting}[frame=tb]
...
\end{lstlisting}
%\caption{Training the controlled tagger.}
\end{codelisting}
...
\begin{codelisting}
\label{listing:useControlledTagger}
\begin{lstlisting}[frame=tb]
...
\end{lstlisting}
%\caption{Using the PageContentExtractor.}
\end{codelisting}
...
\begin{tabular}{|l|c|c|c|}
	...
	\hline
	Boilerpipe & 0,88 & 153 & 44 \\ 
	\hline
	Palladian & 0,89 & 450 & 14 \\ 
	\hline
\end{tabular}
