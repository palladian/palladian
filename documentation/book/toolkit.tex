...
The config folder contains a template for the default Palladian configuration file and the database schemas needed to run some of the components. The files are explained in the following sections.
