...
The framework is licensed under the GNU Lesser General Public License.
	...
	\item \textbf{Java Text Categorizing Library} (JTCL) \cite{KnallgrauTextcat} is a Java library for text classification, mainly with the focus on language guessing. It supports 15 languages and is licensed under the LGPL.
