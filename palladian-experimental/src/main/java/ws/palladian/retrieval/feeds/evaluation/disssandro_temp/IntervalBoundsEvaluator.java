 ...
 * lower bound and 1 day, 1 week and 4 weeks as upper bound. It is presumed, that the given
 * {@link AbstractUpdateStrategy} has
...
public class IntervalBoundsEvaluator extends DatasetEvaluator {
    ...
    /**
     * Start evaluation of an {@link AbstractUpdateStrategy}, doing multiple evaluations using several interval bounds
     * 
     * @param args
     */
        ...
        for (int lowerBound : lowerBounds) {
            for (int upperBound : upperBounds) {
                ...
                // MAVSync
                    ...
                    updateStrategy = new MAVSynchronizationUpdateStrategy(lowerBound, upperBound);
                    logMsg.append(updateStrategy.getName());
                ...
                // IndHist
                    ...
                    updateStrategy = new IndHistUpdateStrategy(lowerBound, upperBound, indHistTheta, feedStore);
                    logMsg.append(updateStrategy.getName());
                ...
                // LIHZUpdateStrategy
                    ...
                    double indHistTheta = config.getDouble("datasetEvaluator.indHistTheta");
                    updateStrategy = new LIHZUpdateStrategy(lowerBound, upperBound, indHistTheta);
                    logMsg.append(updateStrategy.getName());
                }
