...
public class DBExport {
    ...
    public DBExport(String url, String filePath, String pubDate, String modDate, boolean pubSureness, boolean modSureness, String googleDate, String hakiaDate, String askDAte,
            String lastModDate, String dateDate, String actDate) {
        this.url = url;
    ...
    public String toString() {
        ...
        String write = getUrl() + separator + getFilePath() + separator + getPubDate() + separator + String.valueOf(isPubSureness()) + separator + getModDate() + separator
                + String.valueOf(isModSureness()) + separator + getGoogleDate() + separator + getHakiaDate() + separator + getAskDate() + separator + getLastModDate() + separator
                + getDateDate() + separator + getActDate();
