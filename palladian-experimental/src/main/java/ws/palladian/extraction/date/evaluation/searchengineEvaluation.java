...
public class searchengineEvaluation {
    ...
    public static void main(String[] args) {
        ...
        for (Entry<String, DBExport> e : map.entrySet()) {
            ...
            ExtractedDate googleDate = DateParser.findDate(e.getValue().getGoogleDate());
            ExtractedDate hakiaDate = DateParser.findDate(e.getValue().getHakiaDate());
            ExtractedDate askDate = DateParser.findDate(e.getValue().getAskDate());
        ...
        System.out.println("afr: " + googleAFRPub + " ard: " + googleARDPub + " afw: " + googleAFWPub + " awd: " + googleAWDPub + " anf: " + googleANFPub);
        System.out.println("Google Mod:");
        System.out.println("afr: " + googleAFRMod + " ard: " + googleARDMod + " afw: " + googleAFWMod + " awd: " + googleAWDMod + " anf: " + googleANFMod);
        System.out.println("Hakia Pub:");
        System.out.println("afr: " + hakiaAFRPub + " ard: " + hakiaARDPub + " afw: " + hakiaAFWPub + " awd: " + hakiaAWDPub + " anf: " + hakiaANFPub);
        System.out.println("Hakia Mod:");
        System.out.println("afr: " + hakiaAFRMod + " ard: " + hakiaARDMod + " afw: " + hakiaAFWMod + " awd: " + hakiaAWDMod + " anf: " + hakiaANFMod);
        System.out.println("Ask Pub:");
        System.out.println("afr: " + askAFRPub + " ard: " + askARDPub + " afw: " + askAFWPub + " awd: " + askAWDPub + " anf: " + askANFPub);
        System.out.println("Ask Mod:");
        System.out.println("afr: " + askAFRMod + " ard: " + askARDMod + " afw: " + askAFWMod + " awd: " + askAWDMod + " anf: " + askANFMod);
