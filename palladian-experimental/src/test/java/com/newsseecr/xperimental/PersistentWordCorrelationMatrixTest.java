 ...
 * 
 */
public class PersistentWordCorrelationMatrixTest {
    ...
    protected WordCorrelationMatrix getMatrix() {
        return new PersistentWordCorrelationMatrix();
    }
    ...
    public void setUpMatrix() {
        ...
        // System.out.println(wcm.getCorrelations());
    ...
    public static void afterTest() {
        FileHelper.delete("wcmIndex.db");
        FileHelper.delete("wcmIndex.lg");
