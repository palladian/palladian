...
CREATE TABLE IF NOT EXISTS `feeds` (
  ...
  `isAccessibleFeed` TINYINT(1) DEFAULT '0' COMMENT 'Is the feed accessible?',
  `supportsPubSuHubBub` TINYINT(1) NOT NULL DEFAULT '0' COMMENT 'Support of PubSubHubBub',
  `hasItemIds` TINYINT(1) NOT NULL DEFAULT '0' COMMENT 'Do items have an id?',
  ...
  `hasPublished` TINYINT(1) DEFAULT NULL COMMENT 'does the feed support the published element (Atom specific)',
