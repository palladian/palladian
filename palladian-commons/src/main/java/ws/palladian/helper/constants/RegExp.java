...
public class RegExp {
    ...
    private static final String MONTH_NAME_SHORT_ENG = "(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec|JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|SEPT|OCT|NOV|DEC|jan|feb|mar|apr|may|jun|jul|aug|sep|sept|oct|nov|dec)";
    ...
    public static final DateFormat DATE_ISO8601_YMD_T = new DateFormat(YEAR_SHORT_LONG + "-" + MONTH_NUMBER_DOUBLE
            + "-" + DAY_OF_MONTH + ISO_TIME, "YYYY-MM-DDTHH:MM:SS+HH:MM");
    /** <a href="http://en.wikipedia.org/wiki/ISO_8601">ISO8601<a> YYYY-MM-DD TIME+UTC. */
    ...
    /** ISO8601 YYYY-MM . */
    public static final DateFormat DATE_ISO8601_YM = new DateFormat(YEAR_SHORT_LONG + "-" + MONTH_NUMBER_DOUBLE,
            "YYYY-MM");
    ...
    /** ISO8601 YYYY-WW-D . */
    public static final DateFormat DATE_ISO8601_YWD = new DateFormat(
            LONG_YEAR + "-" + WEEK_OF_YEAR + "-" + DAY_OF_WEEK, "YYYY-WW-D");
    /** ISO8601 YYYY-WW . */
    ...
    public static final DateFormat DATE_ISO8601_YMD_NO = new DateFormat(LONG_YEAR + MONTH_NUMBER_DOUBLE + DAY_OF_MONTH,
            "YYYYMMDD");
    /** Year, month and day written without separator: "YYYYWWD". */
    public static final DateFormat DATE_ISO8601_YWD_NO = new DateFormat(LONG_YEAR + WEEK_OF_YEAR + DAY_OF_WEEK,
            "YYYYWWD");
    ...
    public static final DateFormat DATE_URL_D = new DateFormat("(" + DATE_URL_D_1 + "|" + DATE_URL_D_2 + "|"
            + DATE_URL_D_3 + "|" + DATE_URL_D_4 + ")", "YYYY_MM_DD");
    /** Dates in URL: "YYYY_MM_DD". "_" can also be "." or "-" or "/" */
    ...
    public static final DateFormat DATE_URL_SPLIT = new DateFormat(LONG_YEAR + "/.+/" + MONTH_NUMBER_DOUBLE + URL_SYM
            + DAY_OF_MONTH, "YYYY.x.MM.DD");
    ...
    public static final DateFormat DATE_EU_D_MM_Y_T = new DateFormat("(" + DATE_EU_D_MM_Y.getRegex() + TIME_SEPARATOR
            + TIME + "(" + DIFF_UTC + "|" + TIMEZONE + ")?)", "DD.MM.YYYY HH:MM:SS +UTC");
    /** European date. MM.YYYY . */
    public static final DateFormat DATE_EU_MM_Y = new DateFormat(MONTH_NUMBER_NORMAL + SEP_SYM + YEAR_SHORT_LONG,
            "MM.YYYY");
    /** European date. DD.MM. . */
    public static final DateFormat DATE_EU_D_MM = new DateFormat(
            DAY_OF_MONTH_1_2 + "\\." + MONTH_NUMBER_NORMAL + "\\.", "DD.MM.");
    ...
    public static final DateFormat DATE_EU_D_MMMM_Y_T = new DateFormat(DAY_OF_MONTH_1_2 + "(\\.?\\s|-)"
            + MONTH_NAME_LONG + "((,?\\s)|-)" + YEAR_SHORT_LONG + TIME_SEPARATOR + TIME + "(" + DIFF_UTC + "|"
    ...
    public static final DateFormat DATE_USA_MM_D_Y = new DateFormat(MONTH_NUMBER_NORMAL + "/" + DAY_OF_MONTH_1_2 + "/"
            + YEAR_SHORT_LONG, "MM/DD/YYYY");
    /** American date MM/DD/YYYY. HH:MM:SS +UTC. */
    public static final DateFormat DATE_USA_MM_D_Y_T = new DateFormat(MONTH_NUMBER_NORMAL + "/" + DAY_OF_MONTH_1_2
            + "/" + YEAR_SHORT_LONG + TIME_SEPARATOR + TIME + "(" + DIFF_UTC + "|" + TIMEZONE + ")?",
    ...
    public static final DateFormat DATE_USA_MM_D_Y_T_SEPARATOR = new DateFormat("(" + DATE_USA_MM_D_Y_SEPARATOR_1 + "|"
            + DATE_USA_MM_D_Y_SEPARATOR_2 + "|" + DATE_USA_MM_D_Y_SEPARATOR_3 + ")" + TIME_SEPARATOR + TIME + "("
            + DIFF_UTC + "|" + TIMEZONE + ")?", "MM/DD/YYYY HH:MM:SS +UTC");

    /** American date. MM/YYYY . */
    public static final DateFormat DATE_USA_MM_Y = new DateFormat(MONTH_NUMBER_NORMAL + "/" + YEAR_SHORT_LONG,
            "MM/YYYY");
    /** American date. MM/DD . */
    ...
    public static final DateFormat DATE_USA_MMMM_D_Y = new DateFormat(MONTH_NAME_LONG2 + "(\\s|\\.|\\.\\s)"
            + DAY_OF_MONTH_1_2 + "(((" + ST_ND_RD_TH_OPT + "),?)\\s|\\,|\\.\\s?|\\s)" + YEAR_SHORT_LONG,
            "MMMM DD, YYYY");
    public static final DateFormat DATE_USA_MMMM_D_Y_SEP = new DateFormat(MONTH_NAME_LONG + "-" + DAY_OF_MONTH_1_2
            + "-" + YEAR_SHORT_LONG, "MMMM-DD-YYYY");
    /** American date. MMMM DD(st), YYYY HH:MM:SS +UTC. */
    public static final DateFormat DATE_USA_MMMM_D_Y_T = new DateFormat(MONTH_NAME_LONG + " " + DAY_OF_MONTH_1_2
            + ST_ND_RD_TH_OPT + ", " + YEAR_SHORT_LONG + ",?" + TIME_SEPARATOR + TIME + "(" + DIFF_UTC + "|" + TIMEZONE
            + ")?", "MMMM DD, YYYY YYYY HH:MM:SS +UTC");
    /** American date. MMMM DD(st) . */
    public static final DateFormat DATE_USA_MMMM_D = new DateFormat(MONTH_NAME_LONG + " " + DAY_OF_MONTH_1_2
            + ST_ND_RD_TH_OPT, "MMMM DD");

    // US and European dates
    /** American and European date. "MMMM YYYY . */
    public static final DateFormat DATE_EUSA_MMMM_Y = new DateFormat(MONTH_NAME_LONG + " " + YEAR_SHORT_LONG,
            "MMMM YYYY");
    ...
    public static final DateFormat DATE_RFC_1123 = new DateFormat(WEEKDAY_NAME_SHORT + ", " + DAY_OF_MONTH + " "
            + MONTH_NAME_SHORT_ENG + " " + LONG_YEAR + " " + TIME_SEC + TIMEZONE, "WD, DD MMM YYYY HH:MM:SS TZ");
    ...
    public static final DateFormat DATE_RFC_1036 = new DateFormat(WEEKDAY_NAME_LONG + ", " + DAY_OF_MONTH + "-"
            + MONTH_NAME_SHORT_ENG + "-" + SHOR_YEAR + " " + TIME_SEC + TIMEZONE, "WWD, DD-MMM-YY HH:MM:SS TZ");
    /** RFC 1123. WD, DD MMM YYYY HH:MM:SS +UTC . */
    public static final DateFormat DATE_RFC_1123_UTC = new DateFormat(WEEKDAY_NAME_SHORT + ", " + DAY_OF_MONTH + " "
            + MONTH_NAME_SHORT_ENG + " " + LONG_YEAR + " " + TIME_SEC + " " + DIFF_UTC, "WD, DD MMM YYYY HH:MM:SS +UTC");
    /** RFC 1036. WWD, DD-MMM-YYYY HH:MM:SS +UTC . */
    public static final DateFormat DATE_RFC_1036_UTC = new DateFormat(WEEKDAY_NAME_LONG + ", " + DAY_OF_MONTH + "-"
            + MONTH_NAME_SHORT_ENG + "-" + SHOR_YEAR + " " + TIME_SEC + " " + DIFF_UTC, "WWD, DD-MMM-YY HH:MM:SS +UTC");
    /** ANSI C's ascitime. WD MMM DD_1 HH:MM:SS YYYY . */
    public static final DateFormat DATE_ANSI_C = new DateFormat(WEEKDAY_NAME_SHORT + " " + MONTH_NAME_SHORT_ENG + " "
            + DAY_OF_MONTH_1 + " " + TIME_SEC + " " + LONG_YEAR, "WD MMM DD_1 HH:MM:SS YYYY");
    /** ANSI C's ascitime with time difference to UTC. WD MMM DD_1 HH:MM:SS YYYY +UTC. */
    public static final DateFormat DATE_ANSI_C_TZ = new DateFormat(WEEKDAY_NAME_SHORT + " " + MONTH_NAME_SHORT_ENG
            + " " + DAY_OF_MONTH_1 + " " + TIME_SEC + " " + LONG_YEAR + " " + DIFF_UTC,
