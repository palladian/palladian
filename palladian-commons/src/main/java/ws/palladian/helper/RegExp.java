...
public class RegExp {
    ...
    private static final String MONTH_NAME_LONG = "(" + MONTH_NAME_LONG_ENG + "|" + MONTH_NAME_LONG_DT + "|" + MONTH_NAME_SHORT + ")";
    private static final String MONTH_NAME_LONG2 = "(" + MONTH_NAME_LONG_ENG + "|" + MONTH_NAME_LONG_DT + "|" + MONTH_NAME_SHORT2 + ")";
    ...
    public static final DateFormat DATE_ISO8601_YMD_SEPARATOR_T = new DateFormat("(" + DATE_ISO8601_YMD_SEPARATOR_T_1 + "|" + DATE_ISO8601_YMD_SEPARATOR_T_2 + "|" + DATE_ISO8601_YMD_SEPARATOR_T_3 + ")", "YYYY-MM-DDTHH:MM:SS+HH:MM" );
    /** ISO8601 YYYY-MM-DD . */
    ...
    /** ISO8601 YYYY-MM-DD . */
    public static final DateFormat DATE_ISO8601_YMD_SEPARATOR = new DateFormat("(" + DATE_ISO8601_YMD_SEPARATOR_1 + "|" + DATE_ISO8601_YMD_SEPARATOR_2 + "|" + DATE_ISO8601_YMD_SEPARATOR_3 + ")", "YYYY-MM-DD" );
     ...
     * YYYY\...\MM\DD
     */
    public static final DateFormat DATE_URL_SPLIT = new DateFormat(LONG_YEAR + "/.+/" + MONTH_NUMBER_DOUBLE + URL_SYM + DAY_OF_MONTH, "YYYY.x.MM.DD");
...
//    public static final DateFormat DATE_EU_D_MMMM_Y = new DateFormat(DAY_OF_MONTH_1_2 + "(\\.?" + ST_ND_RD_TH_OPT
//            + "\\s|-)" + MONTH_NAME_LONG + "(,?\\s|-)" + YEAR_SHORT_LONG, "DD. MMMM YYYY");
    ...
    public static final DateFormat DATE_EU_D_MMMM_Y_T = new DateFormat(DAY_OF_MONTH_1_2 + "(\\.?\\s|-)" + MONTH_NAME_LONG + "((,?\\s)|-)" + YEAR_SHORT_LONG + TIME_SEPARATOR + TIME + "(" + DIFF_UTC + "|" + TIMEZONE + ")?", "DD. MMMM YYYY HH:MM:SS +UTC" );
    ...
    public static final DateFormat DATE_USA_MM_D_Y_T = new DateFormat(MONTH_NUMBER_NORMAL + "/" + DAY_OF_MONTH_1_2 + "/" + YEAR_SHORT_LONG + TIME_SEPARATOR + TIME + "(" + DIFF_UTC + "|" + TIMEZONE + ")?", "MM/DD/YYYY HH:MM:SS +UTC" );
    ...
    /** American date. MM/DD/YYYY. */
    public static final DateFormat DATE_USA_MM_D_Y_SEPARATOR = new DateFormat("(" + DATE_USA_MM_D_Y_SEPARATOR_1 + "|" + DATE_USA_MM_D_Y_SEPARATOR_2 + "|" + DATE_USA_MM_D_Y_SEPARATOR_3 + ")", "MM/DD/YYYY" );
    
    /** American date. MM/DD/YYYY. */
    public static final DateFormat DATE_USA_MM_D_Y_T_SEPARATOR = new DateFormat("(" + DATE_USA_MM_D_Y_SEPARATOR_1 + "|" + DATE_USA_MM_D_Y_SEPARATOR_2 + "|" + DATE_USA_MM_D_Y_SEPARATOR_3 + ")"+ TIME_SEPARATOR + TIME + "(" + DIFF_UTC + "|" + TIMEZONE + ")?", "MM/DD/YYYY HH:MM:SS +UTC" );
    ...
    public static final DateFormat DATE_USA_MMMM_D_Y = new DateFormat(MONTH_NAME_LONG2 + "(\\s|\\.|\\.\\s)" + DAY_OF_MONTH_1_2 + "(((" + ST_ND_RD_TH_OPT + "),?)\\s|\\,|\\.\\s?|\\s)"  + YEAR_SHORT_LONG, "MMMM DD, YYYY" );
//    public static final DateFormat DATE_USA_MMMM_D_Y = new DateFormat(MONTH_NAME_LONG2 + "(\\s|\\.|\\.\\s)" + DAY_OF_MONTH_1_2 + "(((" + ST_ND_RD_TH_OPT + "),?)|\\.?)" + " " + YEAR_SHORT_LONG, "MMMM DD, YYYY" );
    ...
    public static final DateFormat DATE_RFC_1123 = new DateFormat(WEEKDAY_NAME_SHORT + ", " + DAY_OF_MONTH + " " + MONTH_NAME_SHORT_ENG + " " + LONG_YEAR + " " + TIME_SEC + TIMEZONE, "WD, DD MMM YYYY HH:MM:SS TZ" );
    /** RFC 1036. WWD, DD-MMM-YYYY HH:MM:SS TZ . */
    public static final DateFormat DATE_RFC_1036 =new DateFormat(WEEKDAY_NAME_LONG + ", " + DAY_OF_MONTH + "-" + MONTH_NAME_SHORT_ENG + "-" + SHOR_YEAR + " " + TIME_SEC + TIMEZONE, "WWD, DD-MMM-YY HH:MM:SS TZ" );
    /** RFC 1123. WD, DD MMM YYYY HH:MM:SS +UTC . */
    public static final DateFormat DATE_RFC_1123_UTC = new DateFormat(WEEKDAY_NAME_SHORT + ", " + DAY_OF_MONTH + " " + MONTH_NAME_SHORT_ENG + " " + LONG_YEAR + " " + TIME_SEC + " " + DIFF_UTC, "WD, DD MMM YYYY HH:MM:SS +UTC" );
    /** RFC 1036. WWD, DD-MMM-YYYY HH:MM:SS +UTC . */
    public static final DateFormat DATE_RFC_1036_UTC = new DateFormat(WEEKDAY_NAME_LONG + ", " + DAY_OF_MONTH + "-" + MONTH_NAME_SHORT_ENG + "-" + SHOR_YEAR + " " + TIME_SEC + " " + DIFF_UTC, "WWD, DD-MMM-YY HH:MM:SS +UTC" );
    /** ANSI C's ascitime. WD MMM DD_1 HH:MM:SS YYYY . */
    public static final DateFormat DATE_ANSI_C = new DateFormat(WEEKDAY_NAME_SHORT + " " + MONTH_NAME_SHORT_ENG + " " + DAY_OF_MONTH_1 + " " + TIME_SEC + " " + LONG_YEAR, "WD MMM DD_1 HH:MM:SS YYYY" );
    /** ANSI C's ascitime with time difference to UTC. WD MMM DD_1 HH:MM:SS YYYY +UTC. */
    public static final DateFormat DATE_ANSI_C_TZ = new DateFormat(WEEKDAY_NAME_SHORT + " " + MONTH_NAME_SHORT_ENG + " " + DAY_OF_MONTH_1 + " " + TIME_SEC + " " + LONG_YEAR + " " + DIFF_UTC, "WD MMM DD_1 HH:MM:SS YYYY +UTC" );
