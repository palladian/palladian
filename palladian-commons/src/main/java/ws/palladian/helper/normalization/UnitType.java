...
public enum UnitType {
    ...
    public boolean contains(String unit) {
        for (Pair<List<String>, Double> entry : this.units) {
            for (String unitName : entry.getValue0()) {
    ...
    static {
        ...
        UnitType.NONE.units.add(new Pair<List<String>, Double>(unitList, 1000000000000.0));
        ...
        for (TemperatureUnit tUnit : TemperatureUnit.values()) {
            ...
            UnitType.TEMPERATURE.units.add(new Pair<List<String>, Double>(unitList, null));
        }
        ...
        unitList.add("years");
        unitList.add("year");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 31536000.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("months");
        unitList.add("month");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 2592000.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("weeks");
        unitList.add("week");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 604800.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("day(s)");
        unitList.add("days");
        unitList.add("day");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 86400.0));
        ...
        unitList.add("hr");
        unitList.add("h");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 3600.0));
        ...
        unitList.add("minute");
        unitList.add("min");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 60.0));
        ...
        unitList.add("sec");
        unitList.add("s");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 1.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("milli seconds");
        unitList.add("milliseconds");
        unitList.add("ms");
        UnitType.TIME.units.add(new Pair<List<String>, Double>(unitList, 0.001));
        ...
        unitList.add("tb");
        UnitType.DIGITAL.units.add(new Pair<List<String>, Double>(unitList, 1099511627776.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("giga byte");
        unitList.add("gigabytes");
        unitList.add("gb");
        UnitType.DIGITAL.units.add(new Pair<List<String>, Double>(unitList, 1073741824.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("mega byte");
        unitList.add("megabytes");
        unitList.add("mb");
        UnitType.DIGITAL.units.add(new Pair<List<String>, Double>(unitList, 1048576.0));
        ...
        unitList.add("kb");
        unitList.add("kbyte");
        UnitType.DIGITAL.units.add(new Pair<List<String>, Double>(unitList, 1024.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("byte");
        unitList.add("bytes");
        unitList.add("b");
        UnitType.DIGITAL.units.add(new Pair<List<String>, Double>(unitList, 1.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("bit");
        unitList.add("bits");
        UnitType.DIGITAL.units.add(new Pair<List<String>, Double>(unitList, 1. / 8));
        ...
        unitList.add("ghz");
        UnitType.FREQUENCY.units.add(new Pair<List<String>, Double>(unitList, 1000000000.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("mega hertz");
        unitList.add("megahertz");
        unitList.add("mhz");
        UnitType.FREQUENCY.units.add(new Pair<List<String>, Double>(unitList, 1000000.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("kilo hertz");
        unitList.add("kilohertz");
        unitList.add("khz");
        UnitType.FREQUENCY.units.add(new Pair<List<String>, Double>(unitList, 1000.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("hertz");
        unitList.add("hz");
        UnitType.FREQUENCY.units.add(new Pair<List<String>, Double>(unitList, 1.0));
        ...
        unitList.add("mile");
        unitList.add("mi");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 160934.4));
        ...
        unitList.add("kms");
        unitList.add("km");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 100000.0));
        ...
        unitList.add("metre");
        unitList.add("m");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 100.0));
        ...
        unitList.add("dm");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 10.0));

        unitList = CollectionHelper.newArrayList();
        unitList.add("foot");
        unitList.add("feet");
        unitList.add("ft");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 30.48));
        ...
        unitList.add("in");
        unitList.add("\"");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 2.54));
        ...
        unitList.add("cm");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 1.));
        ...
        unitList.add("mm");
        UnitType.LENGTH.units.add(new Pair<List<String>, Double>(unitList, 0.1));

        // WEIGHT units are normalized to grams
        unitList = CollectionHelper.newArrayList();
        unitList.add("tons");
        unitList.add("ton");
        UnitType.WEIGHT.units.add(new Pair<List<String>, Double>(unitList, 1000000.));
        ...
        unitList.add("kg");
        unitList.add("kgs");
        UnitType.WEIGHT.units.add(new Pair<List<String>, Double>(unitList, 1000.));
        ...
        unitList.add("lbs");
        unitList.add("lb");
        UnitType.WEIGHT.units.add(new Pair<List<String>, Double>(unitList, 453.59237));
        ...
        unitList.add("ozs");
        unitList.add("oz");
        UnitType.WEIGHT.units.add(new Pair<List<String>, Double>(unitList, 28.3495231));
        ...
        unitList.add("gs");
        unitList.add("gr");
        UnitType.WEIGHT.units.add(new Pair<List<String>, Double>(unitList, 1.));
        ...
        unitList.add("sq miles");
        unitList.add("sq mi");
        UnitType.AREA.units.add(new Pair<List<String>, Double>(unitList, 2589988.11));
        ...
        unitList.add("km²");
        unitList.add("km2");
        UnitType.AREA.units.add(new Pair<List<String>, Double>(unitList, 1000000.));

        unitList = CollectionHelper.newArrayList();
        unitList.add("hectares");
        unitList.add("hectare");
        UnitType.AREA.units.add(new Pair<List<String>, Double>(unitList, 10000.));
        ...
        unitList.add("m²");
        unitList.add("m2");
        UnitType.AREA.units.add(new Pair<List<String>, Double>(unitList, 1.));
        ...
        unitList.add("gallon");
        unitList.add("gal");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 3785.41));

        unitList = CollectionHelper.newArrayList();
        unitList.add("liters");
        unitList.add("liter");
        unitList.add("l");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 1000.));
        ...
        unitList.add("qts");
        unitList.add("qt");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 946.353));
        ...
        unitList.add("pts");
        unitList.add("pt");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 473.176));
        ...
        unitList.add("cp");
        unitList.add("c");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 236.588));
        ...
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 29.57));
        ...
        unitList.add("tsp");
        unitList.add("t");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 4.92892));
        ...
        unitList.add("mL");
        unitList.add("cm³");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 1.));
        ...
        unitList.add("shots");
        unitList.add("shot");
        UnitType.VOLUME.units.add(new Pair<List<String>, Double>(unitList, 44.3603));

        // SPEED units are normalized to km/h
        unitList = CollectionHelper.newArrayList();
        unitList.add("miles per hour");
        unitList.add("mph");
        UnitType.SPEED.units.add(new Pair<List<String>, Double>(unitList, 1.609344));
        ...
        unitList.add("kw");
        UnitType.OTHER.units.add(new Pair<List<String>, Double>(unitList, 1.3410));
        ...
        unitList.add("bhp");
        unitList.add("hp");
        UnitType.OTHER.units.add(new Pair<List<String>, Double>(unitList, 1.));
        ...
        unitList.add("ft-lb");
        unitList.add("ft-lbs");
        UnitType.OTHER.units.add(new Pair<List<String>, Double>(unitList, 1.355817952));
        ...
        for (UnitType unitType : values()) {
            ...
            for (Pair<List<String>, Double> pair : unitType.getUnits()) {
                for (String unit : pair.getValue0()) {
