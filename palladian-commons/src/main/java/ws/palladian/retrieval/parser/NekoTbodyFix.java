 ...
 * which have no xhtml namespace. I suspect this is a bug which might get fixed in later versions of NekoHTML. There is
 * test case in DocumentRetrieverTest to track this issue.
 * </p>
 * 
 * @see http://nekohtml.sourceforge.net/changes.html (Version 1.9.13 (2 Sept 2009))
 * @see http://redmine.effingo.de/issues/5
 * @see https://sourceforge.net/tracker/?func=detail&atid=952181&aid=3152446&group_id=195122
 * 
 * @author Philipp Katz
 * 
 */
class NekoTbodyFix extends DefaultFilter {
