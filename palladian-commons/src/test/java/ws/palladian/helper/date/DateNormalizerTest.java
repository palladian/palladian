...
public class DateNormalizerTest {
    ...
    public void testNormalizeDate() {
        ...
        assertEquals("2007-03-12 23:13:05", DateParser.parseDate("Mon, 12 Mar 2007 23:13:05 GMT").getNormalizedDateString());
        assertEquals("2008-10-13 01:28:26", DateParser.parseDate("Mon, 13 Oct 2008 01:28:26 GMT").getNormalizedDateString());
        // System.out.println(DateParser.parseDate("10 Oct 2008 16:34:01 EST"));
        ...
        assertEquals("2006-05-16 06:04:54", DateParser.parseDate("Tue, 16 May 2006 15:04:54 +0900").getNormalizedDateString());
        ...
        // TODO the following tests must work
