...
public class XPathHelperTest {
    ...
    public void testAddNamespaceToXPath() {
        ...
        assertEquals("//xhtml:body[//xhtml:script[contains(text(),',2308,')] and //xhtml:link[@rel='canonical' and contains(@href,'events/more')]]",
                XPathHelper.addXhtmlNsToXPath("//body[//script[contains(text(),',2308,')] and //link[@rel='canonical' and contains(@href,'events/more')]]"));
        assertEquals("//xhtml:body[//xhtml:script[contains(text(),',2308,')] and //xhtml:link[@rel='canonical' and contains(@href,\"/events/\")]]",
                XPathHelper.addXhtmlNsToXPath("//body[//script[contains(text(),',2308,')] and //link[@rel='canonical' and contains(@href,\"/events/\")]]"));
        assertEquals("//xhtml:body[//xhtml:script[contains(text(),',2308,')] and //xhtml:link[@rel='canonical' and contains(@href,'/events/')]]",
                XPathHelper.addXhtmlNsToXPath("//body[//script[contains(text(),',2308,')] and //link[@rel='canonical' and contains(@href,'/events/')]]"));
        ...
        assertEquals(
                ...
                XPathHelper.addXhtmlNsToXPath(
                        "//link[contains(translate(@rel, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'alternate') and (translate(@type, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')='application/atom+xml' or translate(@type, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')='application/rss+xml')]"));
