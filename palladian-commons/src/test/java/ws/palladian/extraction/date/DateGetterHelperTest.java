...
public class DateGetterHelperTest {
    ...
    public void testGetDateFromString() {
        ...
        assertEquals("2010-07-23 15:35:58", DateParser.findDate("July 23rd, 2010 3:35:58 PM")
                .getNormalizedDateString());
        assertEquals("2010-07-23 15:35:58", DateParser.findDate("23. Juli 2010 3:35:58 PM")
                .getNormalizedDateString());
    ...
    public void testFindDate() {
        ...
        assertEquals("2009-04-06 15:11",
                DateParser.findDate("April  6, 2009  3:11 PM").getNormalizedDateString());
