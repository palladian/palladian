...
public final class HackerNewsRankingService extends AbstractRankingService {
	...
	public static final RankingType POINTS = new RankingType("points", "Hacker News Points",
			"The summed points from the first ten hits for the URL on Hacker News.");
	...
	public static final RankingType HITS = new RankingType("hits", "Hacker News Hits",
			"The number of hits for the URL on Hacker News.");
	...
	public Ranking getRanking(String url) throws RankingServiceException {
		String requestUrl = String.format(
				"http://hn.algolia.com/api/v1/search?query=%s&restrictSearchableAttributes=url&hitsPerPage=10",
		...
		try {
			...
			throw new RankingServiceException("Could not parse JSON response: '" + httpResult.getStringContent() + "'.",
					e);
		}
	}
