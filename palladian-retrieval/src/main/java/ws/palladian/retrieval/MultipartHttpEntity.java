...
public final class MultipartHttpEntity implements HttpEntity {
    ...
    /* package */ static final class HttpEntityPart {
        ...
        /* package */ InputStream getInputStream(String boundary) {
            return new SequenceInputStream(new ByteArrayInputStream(buildSectionHeader(boundary)), entity.getInputStream());
        }
    ...
    public static final class Builder implements Factory<MultipartHttpEntity> {
         ...
         *
         * @param entity   The entity, not <code>null</code>.
         * @param name     Name of the entity, not <code>null</code> or empty.
         ...
         *
         * @param boundary The boundary string, not <code>null</code> or empty.
         * @return The builder instance.
         */
