...
public class JsonObjectTest {
    ...
    public void testJQuery() throws JsonException, IOException {
        ...
        collector.checkThat(jso.queryJsonPath("$..allergens"), Matchers
                .is("Milk, soy. Allergen information: this product is processed on equipment that also processes other products that contain peanuts, tree nuts, And wheat."));
        ...
        collector.checkThat(jso.queryJsonPath("$..Warnings..displayValue"), Matchers
                .is("Contains: milk, soy. Allergen Information: This product is processed on equipment that also processes products that contain peanuts, tree nuts, and wheat."));
