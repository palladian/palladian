...
public class MultipartHttpEntityTest {
	...
	public void test_HttpEntityPart_content() {
		MultipartHttpEntity.HttpEntityPart entityPart = new MultipartHttpEntity.HttpEntityPart(
				new StringHttpEntity("foo", "text/plain"), "text", null);
		...
		assertEquals("line 2 must contain Content-Disposition", "Content-Disposition: form-data; name=\"text\"",
				lines[2]);
