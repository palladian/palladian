...
public class NormalizationTest {
    ...
    public void testGetNormalizedNumber() {
        ...
        assertEquals(UnitNormalizer.getNormalizedNumber(21.4, " million. [1]"), 21400000.0, 0);
        assertEquals(UnitNormalizer.getNormalizedNumber(13, " per thousand asdf asdfisdf "), 1.3, 0);
        assertEquals(UnitNormalizer.getNormalizedNumber(13, " per thousand. asdf asdfisdf "), 1.3, 0);
        assertEquals(UnitNormalizer.getNormalizedNumber(13, " per 1000 asdf asdfisdf "), 1.3, 0);
        assertEquals(UnitNormalizer.getNormalizedNumber(1.6, " GHz, 1024MB RAM"), 1600000000.0, 0);
        // TODO?
        ...
        assertEquals(UnitNormalizer.getNormalizedNumber(5, "ft 9 inches"), 175.26, 0);
        ...
        assertEquals(UnitNormalizer.getNormalizedNumber(30, "miles per hour is really fast"), 48.28, 0);
        ...
        assertEquals(UnitNormalizer.getNormalizedNumber(125, "ft-lbs torque!!!"), 169.477, 0);
        assertEquals(UnitNormalizer.getNormalizedNumber(125, "lb-ft torque, and power speed"), 169.477, 0);
