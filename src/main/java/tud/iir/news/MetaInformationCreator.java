...
public class MetaInformationCreator {
    ...
    public void createMetaInformation() {
        ...
        while (fileIterator.hasNext()) {
            ...
            try {
                ...
                writeMetaInformationToDatabase(feed, supports304);
            } catch (IOException e) {
    ...
    private void writeMetaInformationToDatabase(final Feed feed, final Boolean supportsConditionalGet) throws SQLException {
