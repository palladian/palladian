...
/**
 * This is a quickndirty extension of DictionaryClassifier for my feed specific applications. In contrast to the {@link FullPageClassifier} it allows processing
 * of training documents which contain the full text representations, instead of just URLs which link to the appropriate contents. So I can do the training
 ...
 * 
 */
public class TextClassifier extends DictionaryClassifier {
