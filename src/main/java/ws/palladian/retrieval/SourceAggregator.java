...
public class SourceAggregator {
    ...
    //
    // /**
    // * The main function to access the algorithms implemented in this class. It takes an entity as input and provides
    // a list of AggregatedResults as output.
    // *
    ...
    // */
    // public List<AggregatedResult> aggregateWebResults(Entity currentEntity, int method, int maxResults, int
    ...
    // }
    //
    // public List<AggregatedResult> aggregateWebResults(Entity currentEntity, int method, int[] indices, int
    // maxResults, int rankAggregationMethod) {
    //
    ...
    // List<AggregatedResult> awrs = sa.aggregateWebResults(entity, aggregationMethod, indices, maxResults,
    // RankAggregation.RANK_AVERAGE);
