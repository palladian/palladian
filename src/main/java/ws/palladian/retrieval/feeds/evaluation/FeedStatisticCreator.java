...
public class FeedStatisticCreator {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        FeedStatisticCreator.createFeedUpdateIntervalDistribution((FeedDatabase) DatabaseManagerFactory.getInstance()
                .create(FeedDatabase.class.getName()), "data/temp/feedUpdateIntervals.csv");
