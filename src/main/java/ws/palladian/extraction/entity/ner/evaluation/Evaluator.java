...
import ws.palladian.extraction.entity.ner.tagger.PalladianNer.TrainingMode;
...
public class Evaluator {
    ...
    public static void main(String[] args) {
        ...
        // System.exit(0);
        //
        // DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD4/",
        // "www","data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 50, 50, 10);
        // System.exit(0);
