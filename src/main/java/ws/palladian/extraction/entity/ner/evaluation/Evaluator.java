...
public class Evaluator {
    ...
    public static void main(String[] args) {
        ...
        // FileFormatParser.xmlToColumn("data/datasets/ner/tud/manuallyPickedSeeds/seedList.xml",
        // "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", "\t");
        // DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD2/", "www",
        // "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 1, 5, 5);
        // System.exit(0);
