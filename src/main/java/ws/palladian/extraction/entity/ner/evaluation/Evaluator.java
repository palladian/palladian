...
public class Evaluator {
    ...
    public static void main(String[] args) {
        ...
        FileFormatParser.xmlToColumn("data/datasets/ner/tud/manuallyPickedSeeds/seedList2.xml",
                "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", "\t");

        DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD3/", "www",
                "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 50, 50, 5);

        DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD3/", "www",
                "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 40, 40, 5);

        DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD3/", "www",
                "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 30, 30, 5);

        DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD3/", "www",
                "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 20, 20, 5);

        DatasetCreator.generateDatasets("data/temp/autoGeneratedDataTUD3/", "www",
                "data/datasets/ner/tud/manuallyPickedSeeds/seedListC.txt", 10, 10, 5);
        ...
        // taggerList.add(new OpenNLPNER()); // you have to set conllEvaluation to true if used for conll
        ...
        taggerListWebLearning.add(tudnerForIncompleteTraining);
        evaluator.evaluateOnGeneratedTrainingset(taggerListWebLearning, "data/temp/autoGeneratedDataTUD2/",
                tud2011TestPath);
