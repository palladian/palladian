...
import ws.palladian.web.wiki.data.MWCrawlerConfiguration;
import ws.palladian.web.wiki.data.WikiDescriptor;
import ws.palladian.web.wiki.data.WikiDescriptorYAML;
