...
public class KairosEvaluator {
	...
	public static void main(String[] args) {
		...
		evaluate(table, db, pub, PageDateType.publish, dg,
				pub_dr, file);
...
//				dg, mod_dr, file);
		...
		System.out.println("ARF: "
				+ EvaluationHelper.count(file, pub,
						table, db, DataSetHandler.AFR));
		System.out.println("ADR: "
				+ EvaluationHelper.count(file, pub,
						table, db, DataSetHandler.ARD));
		System.out.println("AFW: "
				+ EvaluationHelper.count(file, pub,
						table, db, DataSetHandler.AFW));
		System.out.println("ANF: "
				+ EvaluationHelper.count(file, pub,
						table, db, DataSetHandler.ANF));
		System.out.println("ADW: "
				+ EvaluationHelper.count(file, pub,
						table, db, DataSetHandler.AWD));

		System.out.println(mod);
		System.out.println("AFR: "
				+ EvaluationHelper.count(file, mod,
						table, db, DataSetHandler.AFR));
		System.out.println("ADR: "
				+ EvaluationHelper.count(file, mod,
						table, db, DataSetHandler.ARD));
	...
	public static <T> void evaluate(String table, String db, String round,
			PageDateType pub_mod, TechniqueDateGetter<ContentDate> dg,
